...
VER;
			...
			if(file_exists(IA_ROOT . '/index.php') && is_dir(IA_ROOT . '/app') && is_dir(IA_ROOT . '/web') && file_exists($verfile) && file_exists($dbfile)) {
				...
				die('<script type="text/javascript">alert("你正在使用本地安装, 但未下载完整安装包, 请从微赞CMS下载完整安装包后重试.");history.back();</script>');
			}
		...
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					<li role="presentation" class="active"><a href="javascript:;">安装微CMS赞系统</a></li>
			...
			<div class="footer" style="margin:15px auto;">
				<div class="text-center">
					<a href="http://www.weizancms.com">关于插件商城</a> &nbsp; &nbsp; <a href="http://help.012wz.com">使用帮助</a>
				</div>
				<div class="text-center">
					Powered by <a href="http://www.weizancms.com"><b>微赞CMS</b></a> v0.6 &copy; 2014 <a href="http://www.weizancms.com">www.weizancms.com</a>
				</div>
			</div>
		</div>
	...
	echo <<<EOF
		<div class="panel panel-default">
			...
			<div class="panel-body" style="overflow-y:scroll;max-height:400px;line-height:20px;">
				<h3>版权所有 (c)2014-2015，微赞CMS团队保留部分权利。 </h3>
				<p>
					感谢您选择微赞CMS - 微信公众平台插件开源免费框架（以下简称WEIZANCMS，WEIZANCMS基于 PHP + MySQL的技术开发） <br />
					为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：
				</p>
				<p>
					<strong>一、本授权协议适用且仅适用于微赞CMS系统(WEIZANCMS. 以下简称微赞CMS)任何版本，微赞CMS官方对本授权协议的最终解释权。</strong>
				</p>
				<p>
					<strong>二、协议许可的权利 </strong>
					<ol>
						<li>您可以在协议规定的约束和限制范围内修改微赞CMS源代码或界面风格以适应您的网站要求。</li>
				...
				<p>
					...
					<ol>
						...
						<li>本软件带有其它软件的整合一些第三方文件包，这些文件版权不属于本软件官方，并且这些文件是没经过授权发布的，请参考相关软件的使用许可合法的使用。</li>
					</ol>
				</p>
			</div>
		</div>
...
function tpl_install_finish() {
	...
	<div class="alert alert-warning">
		我们强烈建议您立即注册云服务，享受“插件安装、更新”等云服务。<a target="_blank" class="btn btn-success" href="http://bbs.012wz.com/">马上去注册</a>
		<br />
	</div>
EOF;
	tpl_frame();
