...
<ul class="nav nav-tabs">
		<li class="active"><a href="<?php  echo url('account/display');?>">公众号列表</a></li>
</ul>
<div class="row">
<div class="alert alert-success alert-dismissable">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button><i class="fa fa-bullhorn alert-link">
        </i> 开通的不同版本可以使用不同的权限 <a href="./index.php?c=website&a=taocan-show" target="_blank" style="border-radius: 4px;width: 84%;padding: 8px;font-size: 14px;background-color: #00bc0c;border-color: #00bc0c;color: #FFF">套餐价格、包含应用套餐表</a>
</div>
...
<!-- Pricing -->
		...
		<div class="input-group">
			...
			<a class="btn btn-primary" style="margin-left:5px;" href="<?php  echo url('account/recycle');?>"><i class="fa fa-trash-o"></i> 公众号回收站</a>
		</div>
		<br>
