					...
					<div class="item2" data-title=<?php  echo $row['title'];?> data-type=<?php  echo $row['type'];?>>
						<div class="biz-div">
							...
							<div class="biz-info-0">
								<a href="<?php  echo url('home/welcome/ext', array('m' =>$row['name']))?>" title="<?php  echo $row['title'];?>">
							...
							<div class="biz-info-1">
								...
								<img src="<?php  if(!empty($_W['setting']['copyright']['ewm'])) { ?><?php  echo tomedia($_W['setting']['copyright']['ewm']);?><?php  } else { ?>./resource/weidongli/images/ewm.jpg<?php  } ?>" class="img-rounded" title="<?php  echo $row['title'];?>" height="85" width="85">
								</a>
							</div>
						</div>
					</div>
