...
<?php  if($_W['isfounder']) { ?>
	<div class="clearfix" style="margin-bottom:5em;">
		...
		<div class="clearfix">
			...
			<a href="<?php  echo url('member/member/record');?>" class="tile img-rounded">
				<i class="fa fa-money"></i>
				<span>消费记录</span>
			</a>
			<a href="<?php  echo url('member/member/chongzhi');?>" class="tile img-rounded">
				<i class="fa fa-money"></i>
				<span>充值记录</span>
			</a>
...
<?php  } else { ?>
	<div class="clearfix" style="margin-bottom:5em;">
		...
		<div class="clearfix">
			...
			<a href="<?php  echo url('member/buypackage/buy');?>" class="tile img-rounded">
				<i class="fa fa-briefcase"></i>
				<span>升级续费</span>
			</a>
			<a href="<?php  echo url('user/display');?>" class="tile img-rounded">
