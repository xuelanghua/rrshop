				...
				<div class="col-xs-12 col-sm-3 col-lg-2 big-menu" style="padding-right: 0px;">
					...
					<div class="panel panel-default">
						<div class="panel-heading" style='padding: 14px 15px;'>
							<h4 class="panel-title"><i class="fa fa-th-large"></i> <?php  echo $frame['title'];?></h4>
						...
						<ul class="list-group collapse in" id="frame-<?php  echo $k;?>">
							...
							<li class="list-group-item <?php  echo $link['active'];?>" onclick="window.location.href = '<?php  echo $link['url'];?>';" style="cursor:pointer;padding-left: 33px;" kw="<?php  echo $link['title'];?>">
									<a class="pull-right" href="<?php  echo $link['append']['url'];?>"><?php  echo $link['append']['title'];?></a>
									<?php  echo $link['title'];?>
								</li>
								<?php  } else { ?>
									<a class="list-group-item <?php  echo $link['active'];?>" href="<?php  echo $link['url'];?>" kw="<?php  echo $link['title'];?>" style="padding-left: 33px;"><?php  echo $link['title'];?></a>
								<?php  } ?>
							<?php  } ?>
							<?php  } } ?>
						</ul>
