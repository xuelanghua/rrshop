...
<div class="page-content">
    <div class="page-heading"><h2>说明&通知设置</h2></div>
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="tab_info"  >
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label must">活动说明</label>
            ...
            <div class="tab-pane" id="tab_notice"  >
                <div class="alert alert-warning">当用户获取到新的抽奖机会时回复,此通知链接将指向对应的抽奖活动</div>
                <div class="form-group">
