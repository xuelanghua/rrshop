...
<div class='page-heading'><h2>文章分类  <?php if(cv('system.site.companycategory.edit')) { ?><small>拖动可以排序</small><?php  } ?></h2></div>
    ...
    <table class="table  table-responsive">
        ...
        <tr>
            ...
            <td>
                ...
                <a href="<?php  echo webUrl('system/site/companycategory/delete', array('id' => $row['id']))?>" data-toggle='ajaxRemove' class="btn btn-default btn-sm" data-confirm="确认删除此分类?"><i class="fa fa-trash"></i> 删除</a><?php  } ?>
            </td>
