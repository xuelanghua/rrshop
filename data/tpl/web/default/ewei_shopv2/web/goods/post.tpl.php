    ...
    <div class="tabs-container tab-goods">
        <div class="tabs-left">
            <ul class="nav nav-tabs" id="myTab">
                ...
                <?php  if($merchid == 0) { ?>
                <li <?php  if($_GPC['tab']=='verify') { ?>class="active"<?php  } ?>  <?php  if(($item['type'] == 2 || $item['type'] == 3 || $item['type'] == 10 || $item['type'] == 20)) { ?>style="display: none;"<?php  } ?> id="tab_nav_verify"><a href="#tab_verify">线下核销</a></li>
                <?php  } ?>
