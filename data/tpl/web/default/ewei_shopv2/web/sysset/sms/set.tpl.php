...
<form <?php if(cv('sysset.sms.set')) { ?>method="post"<?php  } ?> class="form-horizontal form-validate">
    ...
    <div class="alert alert-info">
        ...
        <p>短信提醒现支持 <a href="http://www.juhe.cn" target="_blank">聚合数据</a>、<a href="http://www.alidayu.com" target="_blank">阿里大于</a>、<a href="http://www.emay.cn" target="_blank">亿美软通</a>三家行业领先接口，接口所有参数需在此处设置。</p>
    ...
    <div class="form-group-title">阿里大于<small style="padding-left: 10px;"><a target="_blank" href="http://www.alidayu.com">立即申请</a></small>
        <span class="pull-right">
