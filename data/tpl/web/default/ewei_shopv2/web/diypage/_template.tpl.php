    ...
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-cell-group fui-cell-click  fui-sale-group" style="background: <%style.background%>; margin-top: <%style.margintop%>px; margin-bottom: <%style.marginbottom%>px;">
            <%each data as sale%>
                <%if sale.type=='yushou'%>
                    <div class="fui-cell">
                        <div class="fui-cell-text" style="color: <%style.textcolor%>;"><label class="label label-default">预售</label> 预计发货时间：购买后<span class="text-danger" style="color: <%style.textcolorhigh%>;"> 7 </span>天发货</div>
                    </div>
                <%/if%>
                <%if sale.type=='erci'%>
                <div class="fui-cell">
                    <div class="fui-cell-text" style="color: <%style.textcolor%>;">此商品二次购买 可享受 <span class="text-danger" style="color: <%style.textcolorhigh%>;"> 5 </span> 折优惠</div>
                </div>
                <%/if%>
                <%if sale.type=='huiyuan'%>
                <div class="fui-cell">
                    <div class="fui-cell-text" style="color: <%style.textcolor%>;">您的会员等级是<span class="text-danger" style="color: <%style.textcolorhigh%>;"> VIP </span>可享受 <span class="text-danger" style="color: <%style.textcolorhigh%>;">￥10</span> 的价格</div>
                </div>
                <%/if%>
                <%if sale.type=='youhui'%>
                <div class="fui-cell">
                ...
                <%/if%>
                <%if sale.type=='fullback'%>
                <div class="fui-cell">
                    <div class="fui-cell-text" style="color: <%style.textcolorhigh%>;">该商品享受 <b>￥1.00~￥1.00</b> 的全返</div>
                    <div class="fui-cell-remark"></div>
                </div>
                <%/if%>
            <%/each%>
