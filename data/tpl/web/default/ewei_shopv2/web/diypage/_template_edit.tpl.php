            ...
            <div class="item" data-id="<%itemid%>" style="cursor: move">
                <div class="item-form">
                    <%if child.type=='yushou'%>
                        <span style="color: <%style.textcolor%>;"><label class="label label-default">预售</label> 预计发货时间：购买后<span class="text-danger" style="color: <%style.textcolorhigh%>;"> 7 </span>天发货</span>
                    <%/if%>
                    <%if child.type=='erci'%>
                    <span style="color: <%style.textcolor%>;">此商品二次购买 可享受<span class="text-danger" style="color: <%style.textcolorhigh%>;"> 5 </span>折优惠</span>
                    <%/if%>
                    <%if child.type=='huiyuan'%>
                    <span style="color: <%style.textcolor%>;">您的会员等级是<span class="text-danger" style="color: <%style.textcolorhigh%>;"> VIP </span>可享受￥10的价格</span>
                    <%/if%>
                    <%if child.type=='youhui'%>
                    <span style="color: <%style.textcolor%>;">优惠 全场满<span class="text-danger" style="color: <%style.textcolorhigh%>;"> ￥100 </span>包邮</span>
                    <%/if%>
                    <%if child.type=='jifen'%>
                    <span style="color: <%style.textcolor%>;">积分 购买赠送<span class="text-danger" style="color: <%style.textcolorhigh%>;"> 20 </span>积分</span>
                    <%/if%>
                    <%if child.type=='bupeisong'%>
                    <span style="color: <%style.textcolor%>;">不配送区域: 天津辖区 天津辖县 (拖动排序)</span>
                    <%/if%>
                    ...
                    <%if child.type=='coupon'%>
                        <span style="color: <%style.textcolor%>;">领取可用优惠券</span>
                    <%/if%>
                    <%if child.type=='zengpin'%>
                        <span style="color: <%style.textcolor%>;">赠品: 赠品名称</span>
                    <%/if%>
                    <%if child.type=='fullback'%>
                        <span style="color: <%style.textcolorhigh%>;">该商品享受 <b>￥1.00~￥1.00</b> 的全返</span>
                    <%/if%>
                </div>
            </div>
            <%/each%>
...
<script type="text/html" id="tpl_edit_tabbar">
    ...
    <div class="alert alert-info">提示：当访问页面链接等于选项卡中的链接时高亮, 选项卡个数超过三个自动滚动</div>
