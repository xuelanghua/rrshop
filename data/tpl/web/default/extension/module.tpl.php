			...
			<div class="media">
				<div class="pull-right" style="width:500px;">
					...
					<div class="module-set">
						...
						<span class="label label-primary"> <a style="color:#fff" href="http://www.efwww.com/forum.php?mod=forumdisplay&fid=49">
						<i class="fa fa-wrench"></i> 使用交流 </a>
						</span>
						...
						<?php  if($row['upgrade']) { ?><a href="<?php  echo url('extension/module/upgrade', array('m' => $row['name']));?>" onclick="return confirm('确认更新吗？');" style="color:red;" title="来自易福更新">更新</a><?php  } ?>
						</span>
					</div>
				</div>
				...
				try {
					...
					$('.upgrade-label').each(function(){
						...
						if(ret[n]) {
							...
							if($.inArray(n, sys) == -1) {
								$('.hide-form[id="' + n + '"]').html('<span class="label label-warning">来自易福安装</span>').show();
							}
						}
					});
				} catch(err) {}
