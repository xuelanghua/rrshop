...
<ul class="nav nav-tabs">
	<li <?php  if($do == 'list') { ?>class="active"<?php  } ?>><a href="<?php  echo url('fournet/app/list');?>">APP列表</a></li>
	<li <?php  if($do == 'add' && !$id) { ?>class="active"<?php  } ?>><a href="<?php  echo url('fournet/app/add');?>">添加APP</a></li>
	<li <?php  if($do == 'data') { ?>class="active"<?php  } ?>><a href="<?php  echo url('fournet/app/data');?>">APP数据</a></li>
</ul>
<?php  if($do == 'list') { ?>
<div class="clearfix">
			...
			<div class="panel-body table-responsive">
				<table class="table table-hover">
					...
					<?php  if(is_array($data)) { foreach($data as $data) { ?>
						...
						<td><?php  echo $data['InstallNum'];?></td>
						</tr>
					<?php  } } ?>
					</tbody>
				</table>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-8 col-lg-9 col-xs-12">
						<label class="radio-inline"><input type="radio" name="hidetop" value="1" <?php  if($about['hidetop'] == 1) { ?> checked<?php  } ?>>是</label>
						<label class="radio-inline"><input type="radio" name="hidetop" value="0" <?php  if($about['hidetop'] == 0) { ?> checked<?php  } ?>>否</label>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">横竖屏</label>
					<div class="col-sm-8 col-lg-9 col-xs-12">
						<label class="radio-inline"><input type="radio" name="screen" value="1" <?php  if($about['screen'] == 1) { ?> checked<?php  } ?>>横屏</label>
						<label class="radio-inline"><input type="radio" name="screen" value="0" <?php  if($about['screen'] == 0) { ?> checked<?php  } ?>>竖屏</label>
					</div>
				</div>
...
<div class="clearfix">
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<div class="form-group">
					<div class="col-sm-8 col-lg-9 col-xs-12">
						<div class="help-block"><a href="<?php  echo $downloadUrl;?>" target="_blank">下载到电脑</a>
						</div>
					</div>
				</div>
			</div>
