...
<div class="mui-content membership-card-receive">
	...
	<div class="card-panel" style="background-image: url(
		...
		<div class="card-info">
			<div class="mui-text-center">
				<span class="vip" style="color:<?php  if(!empty($setting['color'])) { ?><?php  echo $setting['color'];?><?php  } ?>">VIP</span>
				<span class="card-rank" style="color:<?php  if(!empty($setting['color'])) { ?><?php  echo $setting['color'];?><?php  } ?>"><?php  echo $_W['member']['groupname'];?></span>
			</div>
	...
	<form class="tab-content clearfix js-ajax-form" action="<?php  echo url('mc/card/receive_card');?>" method="post" enctype="multipart/form-data">
...
<?php  if($do == 'mycard') { ?>
	...
	<div class="mui-content membership-card-home mc-we7-home">
		...
		<div class="mui-table mui-table-inline mui-mt15 nav-action">
			...
			<div class="mui-table-cell">
			<a href="<?php  echo url('mc/card/consume') . 'wxref=mp.weixin.qq.com#wechat_redirect'?>">
	...
	<ul class="mui-table-view mui-table-view-chevron">
		<li class="mui-table-view-cell">
			<a href="<?php  echo url('mc/card/activity_description') . 'wxref=mp.weixin.qq.com#wechat_redirect';?>" class="mui-navigate-right">
				优惠说明
			</a>
		</li>
	</ul>
...
<?php  if($do == 'activity_description') { ?>
