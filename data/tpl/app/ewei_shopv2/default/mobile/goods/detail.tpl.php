            ...
            <div class="fui-cell">
                <div class="fui-cell-text">
                    ...
                    <div class="fullback-info">
                        <p><i>&yen;</i>全返总额：
                            <?php  if($fullbackgoods['type']>0) { ?>
                            <?php  if($goods['hasoption'] > 0 && $fullbackgoods['minallfullbackallratio'] != $fullbackgoods['maxallfullbackallratio']) { ?>
                            ...
                            <?php  } ?>
                            <?php  } else { ?>
                            <?php  if($goods['hasoption'] > 0 && $fullbackgoods['minallfullbackallprice'] != $fullbackgoods['maxallfullbackallprice']) { ?>
                        ...
                        <p><i>&yen;</i>每天返：
                            <?php  if($fullbackgoods['type']>0) { ?>
                            <?php  if($goods['hasoption'] > 0 && $fullbackgoods['minfullbackratio'] != $fullbackgoods['maxfullbackratio']) { ?>
                            ...
                            <?php  } ?>
                            <?php  } else { ?>
                            <?php  if($goods['hasoption'] > 0 && $fullbackgoods['minfullbackprice'] != $fullbackgoods['maxfullbackprice']) { ?>
                        ...
                        <p><i>&yen;</i>时间：
                            <?php  if($goods['hasoption'] > 0 && $fullbackgoods['minday'] != $fullbackgoods['maxday']) { ?>
...
<script language='javascript' src='http://api.map.baidu.com/api?v=2.0&ak=ZQiFErjQB7inrGpx27M1GR5w3TxZ64k7&s=1'></script>
<script type="text/javascript">
    if ($('#nearStore').length > 0) {
            ...
            geolocation.getCurrentPosition(function(r) {
                ...
                if (this.getStatus() == BMAP_STATUS_SUCCESS) {
                    ...
                    $(arr[0]).find('.location').append("<span  class='fui-label fui-label-danger'>最近</span>")
